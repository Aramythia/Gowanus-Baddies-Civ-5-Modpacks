...
ContextPtr:LoadNewContext("Inazuma_UA")
ContextPtr:LoadNewContext("MC_AthensFunctions")
ContextPtr:LoadNewContext("MC_MacedonFunctions")
ContextPtr:LoadNewContext("MC_Macedon_GG_GA")
ContextPtr:LoadNewContext("MC_PergamonFunctions")
ContextPtr:LoadNewContext("MC_SpartaFunctions")
ContextPtr:LoadNewContext("BigBossTraitScript")
ContextPtr:LoadNewContext("TopPanelSalvageDisplay")
ContextPtr:LoadNewContext("Wood_Elves_Units_Promotions")
ContextPtr:LoadNewContext("Uniques")
ContextPtr:LoadNewContext("VT MapleFarm")
ContextPtr:LoadNewContext("VT Trait")
ContextPtr:LoadNewContext("Curtin_Functions")
ContextPtr:LoadNewContext("Lua Script1")
ContextPtr:LoadNewContext("BelobogScript")
ContextPtr:LoadNewContext("HoloLua")
